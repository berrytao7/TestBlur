 ...
 */
public class FirstFrameAnimHelper extends AnimatorListenerAdapter
        ...
        sGlobalDrawListener = new ViewTreeObserver.OnDrawListener() {
                ...
                public void onDraw() {
                    ...
                    if (DEBUG) {
                        ...
                        Log.d("FirstFrameAnimHelper", "TICK " + (newTime - mTime));
                        mTime = newTime;
                    }
                }
            };
    ...
    public void print(ValueAnimator animation) {
        ...
        Log.d("FirstFrameAnimHelper", sGlobalFrameCounter +
